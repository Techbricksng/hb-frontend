...
import CustomerInvestmentsPayment from '../../components/dashboards/customer-dashboard/InvestmentPayment';

export default function CustomerInvestmentPaymentPage() {
