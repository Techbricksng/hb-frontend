...
import CustomerPropertyListingPage from '../../components/dashboards/customer-dashboard/MainPropertyDetails';


export default function MainCustomerDetailsPage() {
