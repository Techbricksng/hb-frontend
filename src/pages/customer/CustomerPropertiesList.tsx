...
import CustomerPropertiesListingPage from '../../components/dashboards/customer-dashboard/PropertyListing';

export default function CustomerPropertyListsPage() {
