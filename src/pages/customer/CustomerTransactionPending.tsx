...
import TransactionDetailsPendingPage from '../../components/dashboards/customer-dashboard/TransactionPending';

export default function CustomerTransactionsPendingPage() {
