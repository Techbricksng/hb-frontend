...
import InvestmentRequestDetailsPage from '../../components/dashboards/customer-dashboard/InvestmentRequest';

export default function CustomerInvestmentRequest() {
