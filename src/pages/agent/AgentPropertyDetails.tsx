...
import AgentAvailablePropertyDetails from '../../components/dashboards/agent-dashboard/PropertyDetails';

export default function AgentPropertiesDetailsPage() {
