...
import PropertyEarningsPage from '../../components/dashboards/agent-dashboard/PropertyDetail';

export default function AgentAllPropertiesDetails() {
