...
import CompanyAddPropertyCreate from '../../components/dashboards/company-dashboard/CompanyAddproperty';


export default function CompanyAddProperty() {
